---
title: "Race bloc analysis with CCES vote choice and REPORTED turnout"
author:
  - "Cole Tanigawa-Lau"
date: ""
output:
...
```{r}
turnout$voted <- turnout$voted_report
votechoice$voted      <- votechoice$voted_report
votechoice$vote_pres3 <- votechoice$vote_pres3_report
resamples = 100
```
...
# Export
```{r}
saveRDS(vbdf, "data/vbdf_race_cces_reported.rds")
```
